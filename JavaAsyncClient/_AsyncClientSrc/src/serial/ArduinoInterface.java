...
/** Class logger */
Logger logger = Logger.getLogger("serial.InformationReceiver");
 ...
 * @throws Exception 
 */
public ArduinoInterface(String portN)
throws Exception
{
   portName = portN;
 ...
 */
public abstract void sensorDataReceived(String data);
 ...
 * @param data Sensor data string.
 */
public abstract void infoReceived(String data);
}
